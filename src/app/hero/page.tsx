      ...
      <div className="max-w-7xl w-full px-6 py-10 md:flex md:items-center">
        ...
        <div className="text-center md:text-left md:w-1/2 md:pl-10">
          ...
          <div data-aos="zoom-in" className="flex justify-center md:justify-start gap-4 mb-6">
            ...
            <a 
              href="https://www.facebook.com/profile.php?id=61550887534337&mibextid=ZbWKwL" 
          ...
          <button 
            data-aos="zoom-in" 
            className="bg-orange-600 text-white py-2 px-6 rounded-lg shadow-md hover:bg-gray-500 transition duration-300"
          >
            Connect Me
          </button>
        </div>
